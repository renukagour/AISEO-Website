...
export const Hero = () => {
  return (
   ...
   {/* end ring 1 */}
      {/* start ring 2 */}
      <div className="absolute h-[444px] w-[444px] md:h-[780px] md:w-[780px] rounded-full border border-white/20 left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 border-dashed"></div>
        {/* end ring 2 */}
           {/* start ring 3 */}
